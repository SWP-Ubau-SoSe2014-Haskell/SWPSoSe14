module TestPreProc (
 ...
 -- functions --
 -- testPreProc01 = "PreProcessor: " ~: (erwarteter wert) @=? (PreProc.process eingabe)
 ...
 testModule = undefined -- [testPreProc01,testPreProc02,testPreProc03,testPreProc04,testPreProc05]
